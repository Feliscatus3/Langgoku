      ...
      <div className="container-custom py-12">
        ...
        <div className="max-w-3xl">
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600">Kenali lebih dekat tentang toko digital premium kami</p>
          </div>

          <div className="card p-10 space-y-10 border border-gray-200">
            <section>
            ...
            <section>
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start gap-4 p-3 rounded-xl bg-gray-50 border border-gray-200">
            ...
            <section>
              ...
              <div className="space-y-5">
                <div className="flex gap-5 p-5 bg-gradient-to-r from-gray-50 to-amber-50 rounded-2xl border border-gray-200">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 text-lg">Pilih Produk</h3>
                    <p className="text-gray-700 mt-1">Browsing dan pilih akun premium yang Anda inginkan dari katalog kami</p>
                  </div>
                </div>
                <div className="flex gap-5 p-5 bg-gradient-to-r from-gray-50 to-amber-50 rounded-2xl border border-gray-200">
                  <div className="flex-shrink-0 w-14 h-14 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold text-xl">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 text-lg">Input Data</h3>
                    <p className="text-gray-700 mt-1">Masukkan nama lengkap dan nomor WhatsApp Anda dengan benar</p>
                  </div>
                </div>
                <div className="flex gap-5 p-5 bg-gradient-to-r from-gray-50 to-amber-50 rounded-2xl border border-gray-200">
                  <div className="flex-shrink-0 w-14 h-14 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold text-xl">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 text-lg">Pembayaran</h3>
                    <p className="text-gray-700 mt-1">Scan QRIS atau transfer ke nomor rekening yang tersedia</p>
                  </div>
                </div>
                <div className="flex gap-5 p-5 bg-gradient-to-r from-gray-50 to-amber-50 rounded-2xl border border-gray-200">
                  <div className="flex-shrink-0 w-14 h-14 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold text-xl">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 text-lg">Terima Akun</h3>
                    <p className="text-gray-700 mt-1">Akun dikirim via WhatsApp dalam beberapa menit</p>
                  </div>
                </div>
              </div>
            </section>

            <section className="bg-gradient-to-r from-gray-50 to-amber-50 p-8 rounded-2xl border-2 border-amber-200">
              ...
              <div className="space-y-3">
                <a
                  ...
                  className="flex items-center gap-3 bg-white px-5 py-3 rounded-xl hover:shadow-lg transition-all duration-300 font-semibold text-blue-700 border border-gray-200"
                >
