...
export default function Navbar() {
  ...
  return (
    <nav className="bg-blue-600 sticky top-0 z-50 shadow-xl border-b border-blue-700">
      <div className="container-custom">
        <div className="flex justify-between items-center h-20">
          {/* Logo */}
          <Link href="/" className="flex items-center gap-3 group">
            <div className="w-12 h-12 bg-amber-500 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-lg transition-all duration-300 transform group-hover:scale-110">
              <span className="text-white font-bold text-lg">L</span>
            </div>
            <div className="hidden sm:flex flex-col">
              <span className="font-bold text-xl text-white tracking-tight">Langgoku</span>
              <span className="text-xs text-blue-100 font-medium">Premium Digital</span>
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link href="/" className="text-white/80 hover:text-white font-medium transition-colors duration-300 relative group">
              Produk
              <span className="absolute bottom-0 left-0 w-0 h-1 bg-amber-500 rounded-full transition-all duration-300 group-hover:w-full"></span>
            </Link>
